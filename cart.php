  ...
  <nav role="navigation" class="widescreen clearfix">
    <ul class="font-nav">
 	...
 	<div class="show-for-medium-up">
	  <a class="cart-link" href="./checkout.php">Cart <span class="number-wrapper ">(<span class="number">1</span>)</span><span aria-hidden="true" class="glyph cart"></span></a>
		...
		<div class="recently-added">
		  <table width="100%">
			  ...
			  <tfoot>
			    <tr>
						<td class="items-count"><a href="./checkout.php"><span class="number">1</span> Items</a></td>
			...
			<div class="row"> 
			  <div class="checkout columns">
			    <a class="button" href="./checkout.php">Go to Checkout</a>
			  </div><!-- #cart-meta -->
			</div>
	...
	<div class="show-for-small hide-for-ie9-down">
		...
		<div class="recently-added mobile">
			...
			<div class="row">
				<div class="columns">
					...
					<p class="items-count"><a href="./checkout.php"><span class="number">1</span> Items</a></p>
        ...
        <div class="mobile-tools">
          ...
          <a href="./checkout.php" class="glyph cart"></a>
...
<form action="./checkout.php" method="post" class="custom">
  <div class="row">
    <div class="columns">
  ...
  for($i=0;$i<=(int)$_SESSION["intLine"];$i++)
  {
    ...
    echo '
        ...
        <tr>
          ...
          <td class="remove">
            <a title="Remove" href=" delete.php?Line='.$i.' " aria-hidden="true" class="glyph cross"></a>
    ...
    ?>
      ...
      <h3>Price Total = <?php echo number_format($SumTotal,2);?> </h3>
      ...
      {
      ?>
        <a href="checkout.php"><button class="Button">Check Out!!!</button> </a>
      <?php
      }
      ?>
      <?php
...
<script src="./Your Shopping Cart _ ARTICLE_files/jquery.cart.js" type="text/javascript"></script> 
      ...
      <div class="continue-shopping show-for-medium-up">
        <span><a href="/collections/sale.php"><span aria-hidden="true" class="glyph arrow-left"></span> Continue Shopping</a></span>
      </div>
    </div>
